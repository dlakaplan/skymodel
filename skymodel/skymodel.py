...
class SkyModel:
    ...
    def DM(self, source, distance):
        """
        DM=m.DM(source, distance)

        returns DM in standard units for the given model
        given a source, either a SkyCoord object or a parfile
        and a distance
        ...
        if len(source.ra.shape)==0:
            ...
            while not it.finished:
                ...
                it.iternext()
            return dm*u.pc/u.cm**3
            
    def distance(self, source, DM):
        """
        d=m.distance(source, DM)

        returns distance in kpc for the given model
        given a source, either a SkyCoord object or a parfile
        and a DM
